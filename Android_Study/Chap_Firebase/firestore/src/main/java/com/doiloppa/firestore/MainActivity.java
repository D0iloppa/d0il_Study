package com.doiloppa.firestore;
...
public class MainActivity extends AppCompatActivity  implements View.OnClickListener{
    ...
    private void setData()
    {
        ...
        member.put("name", "권도일");
        member.put("address", "전주");
        member.put("age", 25);

        db.collection("member").document("doiloppa").set(member)
    ...
    {
        FirebaseFirestore db = FirebaseFirestore.getInstance();
        db.collection("member").document("doiloppa").delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
    ...
    private void deleteField()
    {
        ...
        db.collection("member").document("doiloppa").update(updates)
    ...
    {
        FirebaseFirestore db = FirebaseFirestore.getInstance();
        DocumentReference docRef = db.collection("member").document("doiloppa");
    ...
    private void selectWhereDoc(){
        FirebaseFirestore db= FirebaseFirestore.getInstance();
        db.collection("member").whereEqualTo("age",25)
    ...
    {
        FirebaseFirestore db = FirebaseFirestore.getInstance();
        DocumentReference docRef = db.collection("member").document("userinfo");
    ...
    private void listeneQueryDoc(){
        FirebaseFirestore db = FirebaseFirestore.getInstance();
        db.collection("member").whereEqualTo("id","doiloppa")
