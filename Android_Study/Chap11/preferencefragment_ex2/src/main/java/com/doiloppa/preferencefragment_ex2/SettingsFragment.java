...
public class SettingsFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        if (rootKey == null) {
            ...
            if (!prfs.getString("nickname", "").equals("")) {
                editPreference.setSummary(prfs.getString("nickname", "닉네임을 설정하세요"));
            }
    ...
    SharedPreferences.OnSharedPreferenceChangeListener prefListener = new SharedPreferences.OnSharedPreferenceChangeListener() {
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            if (key.equals("sound_list")) soundPreference.setSummary(prfs.getString("sound_list", "카톡"));

            if(prfs.getBoolean("keyword",false)) keywordScreen.setSummary("사용");
            else keywordScreen.setSummary("사용안함");

            if(key.equals("nickname")) editPreference.setSummary(prfs.getString("nickname","닉네임을 설정하세요"));
    ...
    public void onNavigateToScreen(PreferenceScreen preferenceScreen) {
        Intent intent = new Intent(getActivity(), MainActivity.class)
                .putExtra("target", preferenceScreen.getKey());
